...
<?php 
	if($tt_result!=''){
		...
		if($count>3){
			echo "<center><a href='student_trial_test_info.php?data_num=".$key."&sjn=".$subject_num."' target='_blank' style='cursor:pointer;'>+ еще ".($count-$local_count)."</a></center>";
		}
		else if($count!=0 && $count<=3){
			echo "<center><a href='student_trial_test_info.php?data_num=".$key."&sjn=".$subject_num."' target='_blank' style='cursor:pointer;'>Посмотреть подробнее</a></center>";
		}
	}
?>